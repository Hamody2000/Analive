...
<body>
            ...
            <div class="container">
                <div class="navigationbar-row d-flex align-items-center">
                    <div class="logo-col">
                        <h1>
                            <a href="index.html">
                                <img src="assets/images/logo.png" alt="Style theme">
                            </a>
                        </h1>
                    </div>
                    <div class="menu-items-col">
                        <ul class="main-nav">
                                ...
                                <div class="mega-menu menu-dropdown">
                                    <div class="mega-menu-container container">
                                        <ul class="row">
                                            ...
                                            <li class="col-md-3 col-12">
                                                <ul class="megamenu-list arrow-list">
                                                    <li class="list-title"><span>Bags, Suitcases & Luggage</span></li>
                                                    <li><a href="product-list.html">All</a></li>
                                            ...
                                            <li class="col-md-3 col-12">
                                                <ul class="megamenu-list arrow-list">
                                                    ...
                                                    <li><a href="product.html">Women T-shirts & Polo T-shirts</a></li>
                                                    <li><a href="product.html">Women Jeans</a></li>
                                                    <li><a href="product.html">Women Nighties & Night Dresses</a></li>
                            ...
                            <li class="menu-lnk">
                                <a href="product-list.html">Shop All</a>
                            </li>
                            <li class="menu-lnk has-item">
                                <a href="#">
                                    Pages
                        ...
                        <ul class="menu-right d-flex  justify-content-end">
                            ...
                            <li class="profile-header">
                                <a href="my-account.html">
                                    ...
                                    <span class="desk-only icon-lable">My profile</span>
                                </a>
                            </li>
    ...
    <footer class="site-footer">
        <img src="assets/images/right-gilter.png" class="right-gliter gliter-img">
        <div class="container">
            <div class="footer-row">
                <div class="footer-col footer-subscribe-col">
                    <div class="footer-widget">
                        <h3><b>Subscribe to</b> Newsletter</h3>
                ...
                <div class="footer-col footer-link footer-link-2">
                    <div class="footer-widget">
                        ...
                        <ul>  
                            ...
                            <li><a href="order-summery.html">Order summery</a></li>
            ...
            <div class="footer-bottom">
                <div class="row align-items-center">
                    <div class="col-12 col-md-6">
                        <p>© 2022 Style. All rights reserved</p>
                    </div>
                    <div class="col-12 col-md-6">
    ...
    <div class="cartDrawer">
        ...
        <div id="cart-body" class="mini-cart-has-item">
            <div class="mini-cart-body">
                <div class="mini-cart-item">
                    <div class="mini-cart-image">
                        <a href="product.html">
                            <img src="assets/images/cart1.png" alt="img">
                        </a>
                    </div>
                    <div class="mini-cart-details">
                        <p class="mini-cart-title"><a href="product.html">Classic Goggels</a></p>
            ...
            <div class="mini-cart-footer">
                ...
                <a href="product-list.html" class="link-btn">
                    Continue Shopping
    ...
    <!-- <div class="cookie">
        <p>We use our own and third-party cookies to improve your experience and our services, and to analyse the use of our website. If you continue browsing, we take that to mean that you accept their use. See info.</p>
    ...
    <script src="assets/js/slick-lightbox.js" defer="defer"></script>
