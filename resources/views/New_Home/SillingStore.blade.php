...
<head>
    ...
    <!-- Uncomment the next line if you want to use the CDN version of Bootstrap -->
    ...
    <link href="{{ asset('home_assets/Libs/bootstrap-datepicker/css/bootstrap-datepicker.min.css') }}" rel="stylesheet" type="text/css">
    <link rel="stylesheet" href="{{ asset('home_assets/Libs/%40chenfengyuan/datepicker/datepicker.min.css') }}">
        ...
        <div class="container">
            ...
            <div class="menu-cnt">
                ...
                <div class="menu-right">
                    <ul class="lan-menu">
                        <li class="dropdown">
                            <a href="Ar/SillingStore.html"><img src="{{ asset('home_assets/images/eg.png') }}" alt="" />AR </a>
                        </li>
                    </ul>
...
<!--
                        <div class="mb-4">
                            ...
                            <div class="input-group" id="datepicker2">
                                ...
                                <input type="date" id="ddddddd" class="form-control" placeholder="dd M, yyyy"
                                    data-date-format="dd M, yyyy" data-date-container='#datepicker2' data-provide="datepicker"
                                    data-date-autoclose="true">
...
<!--                                    <span>يجب ادخال البيانات كما هو مذكور وموضح في أوراق شركتك الرسمية (السجل التجاري)</span>-->
                                    <span class="" 
                                                        data-container="body" 
                                                        data-toggle="popover" 
                                                        data-trigger="hover" 
                                                        data-placement="top" 
                                                        data-content="All data must be entered as shown/stated in your official company papers (Commercial Register ID)">
                                                        <i class="fas fa-question"></i>
                                                </span></h4>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label class="LableText">Company Name/Business Name *
                                            </label>
                                            <div class="fomgroupDisplayFlex">
                                                <div class="fomgroupDisplayCOntent">
                                                    <input type="text" placeholder="Company Name/Business Name " class="form-control " required>
<!--
                                                    <span class="text-success"><i class="fas fa-check"></i></span>
                                                    <span class="text-danger"><i class="fas fa-times"></i></span>
-->
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label class="LableText">Authorized Signature Person Full Name *
<!--                                                <span>يجب ادخال الاسم كاملا للمفوض عن إدارة الشركة كما هو مذكور وموضح بالسجل التجاري</span>-->
                                                <span class="" 
                                                        data-container="body" 
                                                        data-toggle="popover" 
                                                        data-trigger="hover" 
                                                        data-placement="top" 
                                                        data-content="Full name of authorized person of the company must be entered as shown/stated in Commercial Register ID">
                                                        <i class="fas fa-question"></i>
                                                </span>
                                            </label>
                                            <div class="fomgroupDisplayFlex">
...
-->
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            <label class="LableText">Company Address *</label>
                                            <div class="fomgroupDisplayFlex">
                                                <div class="fomgroupDisplayCOntent">
...
-->
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label class="LableText">Commercial Register Number *</label>
                                            
                                            <div class="fomgroupDisplayFlex">
                                                <div class="fomgroupDisplayCOntent">
                                                    <input type="text" placeholder="Commercial Register Number" class="form-control" required>
                                                    <span class="text-success"><i class="fas fa-check"></i></span>
                                                    <span class="text-danger"><i class="fas fa-times"></i></span>
                                                </div>
                                            </div>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label class="LableText">Tax ID Number *</label>
                                            <div class="fomgroupDisplayFlex">
                                                <div class="fomgroupDisplayCOntent">
                                                    <input type="text" placeholder="Tax ID Number" class="form-control" required>
                                                    <span class="text-success"><i class="fas fa-check"></i></span>
                                                    <span class="text-danger"><i class="fas fa-times"></i></span>
                                                </div>
                                            </div>
...
-->
                         ...
                         <div class="card mb-3">
                            <div class="card-body">
                                <h4>Company Official Papers:</h4>
                                <div class="row">
                                    
                                    <div class="col-lg-4">
                                        <div class="form-group FileUplaod">
                                            <label class="LableText">Company Commercial Register ID *
<!--                                                <span>مسح ضوئي لمستند او صورة واضحة وعالية الجودة لأحدث سجل تجاري خاص بك (بحد أقصى 3 أشهر)</span>-->
                                                <span class="" 
                                                        data-container="body" 
                                                        data-toggle="popover" 
                                                        data-trigger="hover" 
                                                        data-placement="top" 
                                                        data-content="Clear and high quality scan document/photo of your newest commercial register (Maximum 3 Months old)">
                                                        <i class="fas fa-question"></i>
                                                </span>
                                            </label>
                                            <div class="fomgroupDisplayFlex">
                                                <div class="fomgroupDisplayCOntent">
                                                    <input type="file" placeholder="Write you domain" class="form-control" required>
                                                    <span class="text-success"><i class="fas fa-check"></i></span>
                                                    <span class="text-danger"><i class="fas fa-times"></i></span>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group width_80">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group FileUplaod">
                                            <label class="LableText">Tax ID *
<!--                                                <span>مسح ضوئي لمستند او صورة واضحة وعالية الجودة للبطاقة الضريبية السارية الخاصة بك</span>-->
                                                <span class="" 
                                                        data-container="body" 
                                                        data-toggle="popover" 
                                                        data-trigger="hover" 
                                                        data-placement="top" 
                                                        data-content=" Clear and high quality scan document/photo of your valid Taxation ID Card">
                                                        <i class="fas fa-question"></i>
                                                </span>    
                                            ...
                                            <div class="fomgroupDisplayFlex">
                                                <div class="fomgroupDisplayCOntent">
                                                    <input type="file" placeholder="First Name" class="form-control" required>
                                                    <span class="text-success"><i class="fas fa-check"></i></span>
                                                    <span class="text-danger"><i class="fas fa-times"></i></span>
                                                </div>
                                            </div>
                                        ...
                                        <div class="form-group width_80">
                                            ...
                                            <div class="fomgroupDisplayFlex mb-0">
                                                <div class="fomgroupDisplayCOntent">
                                                   <input id="start2" type="date" class="form-control" required>
                                                    <span class="IconCalnder"><i class="far fa-calendar-alt"></i></span>
                                                </div>
                                            </div>
                                        </div>
...
<!--                                                <span>مسح ضوئي لمستند او صورة عالية الجودة لبطاقة الرقم القومي لوجهين البطاقة السارية للمفوض عن إدارة الشركة كما هو مذكور وموضح بالسجل التجاري</span>-->
                                                <span class="" 
                                                        data-container="body" 
                                                        data-toggle="popover" 
                                                        data-trigger="hover" 
                                                        data-placement="top" 
                                                        data-content="Clear and high quality scan document/photo for National ID (2Sides) of authorized person of the company as shown/stated in Commercial Register ID.">
                                                        <i class="fas fa-question"></i>
                                                </span>
                                            </label>
                                            <div class="fomgroupDisplayFlex">
                                        ...
                                        <div class="form-group width_80">
                                            ...
                                            <div class="fomgroupDisplayFlex mb-0">
                                                <div class="fomgroupDisplayCOntent">
                                                   <input type="date" id="start3" class="form-control" required>
                                                    <span class="IconCalnder"><i class="far fa-calendar-alt"></i></span>
                                                </div>
                                            </div>
                                        </div>
...
-->
    ...
    <footer class="footer-parallax light">
        ...
        <div class="footer-bar">
            <div class="container">
                ...
                <span><img src="assets/images/logo-light.svg" alt="" /></span>
            </div>
        </div>
    </footer>
  ...
  <div class="modal-dialog modal-lg">
    ...
    <script src="{{ asset('home_assets/Libs/bootstrap-datepicker/js/bootstrap-datepicker.min.js') }}"></script>
    <script src="{{ asset('home_assets/Libs/%40chenfengyuan/datepicker/datepicker.min.js') }}"></script>
