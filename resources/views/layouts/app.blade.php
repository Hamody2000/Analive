...
<head>
    ...
    <!-- Photo Editor -->
    <link rel="stylesheet" href="{{ asset('editor_assets/css/style.css') }}">
    <link rel="stylesheet" href="{{ asset('editor_assets/css/loader.css') }}">
    <link href="{{ asset('editor_assets/css/boxicons.min.css') }}" rel='stylesheet'>
