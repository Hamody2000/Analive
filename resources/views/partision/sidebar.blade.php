        ...
        <ul class="dash-navbar">
            ...
            @if (Auth::user()->can('Manage Products') ||
                    ...
                    <li class="dash-item dash-hasmenu">
                        ...
                        </span><span class="dash-mtext">{{ __('Auto Poster') }}</span>
                            <span class="dash-arrow"><i data-feather="chevron-right"></i></span>
                        </a>
                        <ul
                            class="dash-submenu {{ Request::segment(1) == 'main-category' || Request::segment(1) == 'sub-category' ? 'show' : '' }}">
                            @can('Manage Products')
                                <li
                                    class="dash-item {{ in_array(Request::segment(1), ['product', 'product-variant']) ? ' active' : '' }}">
                                    <a class="dash-link" href="{{ route('admin.product-facebook-auto-poster') }}">{{ __('Facebook Connection') }}</a>
                                </li>
                            @endcan
                            ...
                            @can('Manage Products')
                                <li
                                    class="dash-item {{ in_array(Request::segment(1), ['product-attribute', 'attribute-option']) ? ' active' : '' }}">
                                    <a class="dash-link"
                                       href="{{ route('admin.product-instagram-auto-poster') }}">{{ __('Instagram Connection') }}</a>
                                </li>
                            @endcan
                        </ul>
                    </li>
            ...
            {{-- Start PhotoEditor Tap --}}
            @if (Auth::user()->can('Manage Products'))
                    <li class="dash-item dash-hasmenu">
                        <a href="#!" class="dash-link ">
                        <span class="dash-micon"><i class="ti ti-photo"></i>
                        </span><span class="dash-mtext">{{ __('Photo Editor') }}</span>
                            <span class="dash-arrow"><i data-feather="chevron-right"></i></span>
                        </a>
                        <ul
                            class="dash-submenu {{ Request::segment(1) == 'main-category' || Request::segment(1) == 'sub-category' ? 'show' : '' }}">
                            @can('Manage Products')
                                <li
                                    class="dash-item {{ in_array(Request::segment(1), ['product', 'product-variant']) ? ' active' : '' }}">
                                    <a class="dash-link" href="{{ route('admin.product-photo-editor') }}">{{ __('Open Photo Editor') }}</a>
                                </li>
                            @endcan
                        </ul>
                    </li>
