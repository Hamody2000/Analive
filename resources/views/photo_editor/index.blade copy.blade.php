...
@section('breadcrumb')
   <li class="breadcrumb-item">{{ __('Photo Editor ') }}</li>
@endsection

@section('content')
   <div style="position: relative !important; margin-bottom: 15px">
      @include('photo_editor.editor')
   </div>
@endsection
...
@push('custom-script1')
   ...
   <script src="{{ asset('editor_assets/js/jquery.min.js') }}"></script>
   <script src="{{ asset('editor_assets/js/script.js') }}"></script>
@endpush
