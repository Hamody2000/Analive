...
<html>
    <head>
        ...
        <link rel="stylesheet" href="http://localhost:8000/editor_assets/css/main.css?v23">
    ...
    <body >
        ...
        <div class="" id="editor" ng-app="ImageEditor" ng-strict-di>
            ...
            <div ng-controller="MainController" ng-cloak style="height: 100%">
                ...
                <section ng-hide="!loading" id="spinner" style="display: none;">
                    ...
                    <div id="tabs">
                        <section id="basics" data-index="1" class="tab">
                            ...
                            <div class="basics-item">
                                <div onclick="removeBG()" >
                                    <i class="mdi mdi-image basics-icon"></i>
                                    <div class="icon-title">Remove BG</div>
                                </div>
                            </div>
                        ...
                        <section id="drawing" class="tab" data-index="3" ng-controller="DrawingController">
                            ...
                            <div id="brushes">
                                <div ng-repeat="brush in drawing.availableBrushes" ng-class="{ active: drawing.activeBrushName == brush }" class="brush" ng-click="changeBrush(brush, $event)">
                                    <img title="{{ brush }}" class="img-responsive" ng-src="http://localhost:8000/editor_assets/images/brushes/{{brush}}.png"/>
                                </div>
                            </div>
                            ...
                            <div class="filters-list row" ed-pretty-scrollbar ed-scroll-axis="y" ed-scroll-theme="light">
                                <figure ng-class="{ applied: filters.filterAlreadyApplied(filter.name) }" ng-repeat="filter in filters.all" ng-click="filters.applyFilter(filter)" class="filter col-sm-6">
                                    <div class="filter-image">
                                        <img ng-src="http://localhost:8000/editor_assets/images/filters/{{ filter.name.toLowerCase() }}.png" class="img-responsive md-whiteframe-z1"/>
                                ...
                                <section ng-repeat="category in categories" class="sticker-category-container">
                                    ...
                                    <div class="category-stickers" ng-class="{ 'open animated slideInDown': activeCategory === category.name, 'dark-bg': category.darkbg }">
                                        <div ng-repeat="doodle in category.items track by $index" ng-click="addToCanvas(category, $index+1, $event)" class="sticker">
                                            <img class="img-responsive" data-src="http://localhost:8000/editor_assets/images/stickers/{{category.name}}/{{$index+1}}.{{ category.type }}"/>
                                        </div>
                                    </div>
                                </section>
                            </div>
        ...
        <script type="application/ng-template" id="gradient-sheet-template">
            <md-bottom-sheet class="bottom-sheet gradients-sheet">
                <div class="items-list" ed-pretty-scrollbar>
                    <div ng-repeat="g in shapes.gradients" ng-style="{background: 'url(http://localhost:8000/editor_assets/images/gradients/'+($index+1)+'.png)'}" ng-click="shapes.fillWithGradient($index+1)" class="item md-whiteframe-z1"></div>
                </div>
            </md-bottom-sheet>
        </script>
        ...
        <script type="application/ng-template" id="image-sheet-template">
            <md-bottom-sheet class="bottom-sheet images-sheet">
                ...
                <div class="items-list" ed-pretty-scrollbar>
                    <div ng-repeat="t in shapes.textures track by $index" ng-style="{background: 'url(http://localhost:8000/editor_assets/images/textures/'+$index+'.png)'}" ng-click="shapes.fillWithImage('http://localhost:8000/editor_assets/images/textures/'+$index+'.png')" class="item md-whiteframe-z1"></div>
                </div>
            </md-bottom-sheet>
        </script>
        ...
        <script>
            function removeBG(){
                ...
                console.log(object, 'testttttttttt');
                if (object.type == 'image') {
                    let img = object.getSrc();
                    window.open(img);
                } else {
                    alert('no img found');
                }
