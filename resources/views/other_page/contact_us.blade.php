...
<head>
    ...
    <link
        ...
        rel="stylesheet">
    <link rel="stylesheet" href="{{ asset('assets/frontend/assets/css/main-style.css') }}">
...
<body>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12 col-12">
                                        <div class="form-group">
                                            ...
                                            <div class="nice-select form-control" tabindex="0"><span
                                                    class="current">Customer service</span>
                                                <ul class="list">
                                                    <li data-value="2" class="option selected">Customer service</li>
                                                    <li data-value="1" class="option">Webmaster</li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-12 col-12">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" name="message" placeholder="How can we help?" rows="8"></textarea>
                                        </div>
                                    </div>
                                </div>
    ...
    <script src="{{ asset('assets/frontend/assets/js/slick.min.js') }}" defer="defer"></script>
    <script src="{{ asset('assets/frontend/assets/js/slick-lightbox.js') }}" defer="defer"></script>
    <script src='{{ asset('assets/frontend/assets/js/custom.js') }}' defer="defer"></script>
    <!--scripts end here-->
</body>
