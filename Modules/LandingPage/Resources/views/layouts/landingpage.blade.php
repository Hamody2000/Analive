...
<head>
    ...
    @else
        <link rel="stylesheet" href="{{ Module::asset('LandingPage:Resources/assets/css/style.css') }}"
            id="main-style-link">
        <link rel="stylesheet" href="{{ Module::asset('LandingPage:Resources/assets/css/NewStyle.css') }}"
            id="main-style-link">
    @endif
...
@if ($settings['home_status'] == 'on')
    <section class="main-banner bg-primary BannerHomePage" id="home" style="background-image: url('{{ asset('home_assets/images/bg.svg') }}') !important;">
            ...
            <div class="row gy-3 g-0 align-items-center">
                <div class="col-xxl-4 col-md-6">
                    ...
                    <div class="d-flex gap-3 mt-4 banner-btn">
                        <a href="{{ route('admin.login') }}" class="btn btn-outline-dark LoginToShop">Login To Shop</a>
                        @if ($adminSettings['SIGNUP'] == 'on')
                            <a href="{{ route('admin.register') }}" class="btn btn-outline-dark LoginToShop">Register New Shop</a>
                        @endif
                    </div>
                </div>
        ...
        <div class="container">
            ...
            <div class="d-flex flex-column justify-content-center flex-sm-row gap-3 mt-3">
                ...
                @if ($settings['discover_buy_now_link'])
                    <a href="{{ route('admin.register') }}" class="btn btn-primary rounded-pill">Register Now
