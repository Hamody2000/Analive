...
use Illuminate\Support\Facades\Route;
    ...
    Route::get('admin/selling-from-store', function () { return view('auth.register-from-store'); })->name('selling.store')->middleware(['guest:admin','setlocate']);
    Route::get('admin/selling-from-home', function () { return view('auth.register-from-home'); })->name('selling.home')->middleware(['guest:admin','setlocate']);
