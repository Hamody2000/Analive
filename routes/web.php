...
use App\Http\Controllers\ProductAutoPosterController;
use Aws\Middleware;
...
// Route::get('/', function () {
//     return view('New_Home.index');
// })->name('home');

// Route::get('/tutorials', function () {
//     return view('New_Home.toutrial');
// })->name('tutorials');

// Route::get('/faq', function () {
//     return view('New_Home.FAQ');
// })->name('faq');

// Route::get('/selling-home', function () {
//     return view('New_Home.SellingHome');
// })->name('selling_home');

// Route::get('/selling-store', function () {
//     return view('New_Home.SillingStore');
// })->name('selling_store');
...
// Route::prefix('{slug}')->group(function(){
    ...
    Route::prefix('admin')->as('admin.')->group(function(){
        ...
        Route::get('product-facebook-auto-poster', [ProductAutoPosterController::class, 'facebookLogin'])->middleware(['auth:admin','xss','setlocate'])->name('product-facebook-auto-poster');
        Route::get('product-instagram-auto-poster', [ProductAutoPosterController::class, 'instagramLogin'])->middleware(['auth:admin','xss','setlocate'])->name('product-instagram-auto-poster');

        // Photo Editor Routes
        Route::get('product-photo-editor', function () { return view('photo_editor.index'); })->middleware(['auth:admin','xss','setlocate'])->name('product-photo-editor');
        // Photo Editor Routes
        ...
        Route::get('generate2/{template_name}',[AITemplateController::class,'createPhotoEditor'])->name('generate2')->middleware(['auth:admin','xss','setlocate']);
        ...
        Route::resource('users', UserController::class)->middleware(['auth:admin','xss']);
        Route::get('users/reset/{id}',[UserController::class,'reset'])->name('users.reset')->middleware(['auth:admin','xss']);
        Route::post('users/reset/{id}',[UserController::class,'updatePassword'])->name('users.resetpassword')->middleware(['auth:admin','xss']);

        Route::resource('roles', RoleController::class)->middleware(['auth:admin','xss']);
