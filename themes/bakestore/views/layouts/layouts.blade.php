...
<body
    @if (in_array(\Request::route()->getName(), ['landing_page'])) class="home-bg home-page" @elseif(in_array(\Request::route()->getName(), ['page.product'])) class="product-bg home-page" @elseif (in_array(\Request::route()->getName(), ['my-account'])) class="my-acc-body home-page" @endif>
