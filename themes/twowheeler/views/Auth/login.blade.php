                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="email" name="email" id="email" class="form-control" placeholder="shop@company.com" required="" value="twowheeler@example.com">
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            <label>{{ _('Password') }}<sup aria-hidden="true">*</sup>:</label>
                                            <input type="password" name="password" id="password" class="form-control" placeholder="**********" required="" value="twowheeler@example.com">
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<script>
    ...
    $(document).on("click", "#login_button", function () {
        $("#email").val('twowheeler@example.com');
        $("#password").val('twowheeler@example.com');
