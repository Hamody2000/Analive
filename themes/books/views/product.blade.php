                                ...
                                <div class="pdp-content-bottom">
                                    ...
                                    <div class="bottom-content">
                                        @if ($product->variant_id != 0)
                                            <b> {!! \App\Models\ProductStock::variantlist($product->attribute_id) !!} </b>
                                        @endif
                                ...
                                <div class="category-card-content">
                                    ...
                                    <div class="category-cont-bottom">
                                        <div class="price-btn">
                                            ...
                                            @endif
                                            <a href="javascript:void(0)" class="link-btn addcart-btn-globaly" product_id="{{ $product->id }}" variant_id="0" qty="1">
                                                {{ __('Add to cart') }}
                                                <svg xmlns="http://www.w3.org/2000/svg" width="14" height="16" viewBox="0 0 14 16"
                                                    fill="none">
                                                    <path fill-rule="evenodd" clip-rule="evenodd"
                        ...
                        <div class="category-itm product-card">
                            ...
                            <div class="category-card-inner">
                                ...
                                <div class="category-card-content">
                                    ...
                                    <div class="category-cont-bottom">
                                        <div class="price-btn">
                                            @if ($productss->variant_product == 0)
                                                <div class="price">
                                                    <span
                                                    class="currency-type">{{ $currency_icon }}</span>
                                            ...
                                            @endif
                                            <a href="javascript:void(0)" class="link-btn addcart-btn-globaly" product_id="{{ $productss->id }}" variant_id="0" qty="1">
