...
<head>
    ...
    <title>
        {{ \App\Models\Utility::GetValueByName('theme_name', $theme_name) ? \App\Models\Utility::GetValueByName('theme_name', $theme_name) : ' Books' }}
    ...
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
    <link
        href="https://fonts.googleapis.com/css2?family=Outfit:wght@100;200;300;400;500;600;700;800;900&family=Quicksand:wght@300;400;500;600;700&display=swap"
        rel="stylesheet">
...
<body
    @if (in_array(\Request::route()->getName(), ['landing_page', $slug])) class="home-page"  @elseif(in_array(\Request::route()->getName(), ['page.product', $slug]))  class="product-page home-page" @else class="home-page" @endif>
