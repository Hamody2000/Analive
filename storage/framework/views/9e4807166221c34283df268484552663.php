            ...
            <div class="row">
                ...
                <div class="col-xl-9">
                    <div class="card">
                        ...
                        <?php echo e(Form::open(array('route' => 'admin.homesection.store', 'method'=>'post', 'enctype' => "multipart/form-data",'id' => 'imageUploadForm'))); ?>
                                                        ...
                                                        <div class="row align-items-center">
                                                            ...
                                                            <div class="col-auto">
                                                                <p class="card-text small text-muted">
                                                                    <img class="rounded" src="<?php echo e($logo.'/placeholder.png'); ?>" width="70px" alt="Image placeholder" data-dz-thumbnail="">
                                                ...
                                                <div class="card mb-3 border shadow-none product_Image">
                                                    <div class="px-2 py-2">
                                                        <div class="row align-items-center">
                                                            ...
                                                            <div class="col-auto actions">
                                                                <a class="action-item btn btn-sm btn-icon btn-info" href="<?php echo e($logo.'/'.$home_logo); ?>" download="" data-toggle="tooltip" data-original-title="Download">
                                                                    <i class="ti ti-download"></i>
                                                                </a>
                                                            </div>
                                                            <div class="col-auto actions">
                                                                <a class="action-item btn btn-sm btn-icon btn btn-sm btn-danger delete-button " data-image="<?php echo e($home_logo); ?>">
                                                                    <i class="ti ti-trash text-white py-1"></i>
                                                                </a>
                                                            </div>
                                                        </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\Hussein\Lean\Developments\AnaOnline_New\AnaLive\AnaLive\Modules/LandingPage\Resources/views/landingpage/homesection.blade.php ENDPATH**/ ?>