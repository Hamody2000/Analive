...
<?php endif; ?>
        ...
        <form method="POST" action="<?php echo e(route('admin.login')); ?>">
            ...
            <div class="form-group mb-3">
                ...
                <?php if (isset($component)) { $__componentOriginal71c6471fa76ce19017edc287b6f4508c = $component; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.input','data' => ['id' => 'email','class' => 'form-control','type' => 'email','name' => 'email','value' => old('email'),'required' => true,'autofocus' => true]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
unset($__errorArgs, $__bag); ?>
            ...
            <p class="my-4 text-center"><?php echo e(__("Don't have an account?")); ?>
                ...
                <a href="<?php echo e(route('admin.register')); ?>" class="my-4 text-primary"><?php echo e(__('Register')); ?></a>
                <?php endif; ?>
            </p>
...
<?php echo $__env->make('layouts.guest', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\Hussein\Lean\Developments\AnaOnline_New\AnaLive\AnaLive\resources\views/auth/login.blade.php ENDPATH**/ ?>