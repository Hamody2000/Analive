        ...
        <div class="col-sm-12">
            <div class="row ">
                                ...
                                <div class="col-lg-3 col-6">
                                    <div class="card stats-wrapper info-card">
                                        <div class="card-body stats">
                                            ...
                                            <h6 class="mt-4 mb-2"><?php echo e(__('Total Products')); ?></h6>
                                            <h3 class="mb-0"><?php echo e($totalproduct); ?> <span class="text-success text-sm">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-3 col-6">
                                    <div class="card stats-wrapper info-card">
                                        <div class="card-body stats">
                                            ...
                                            <h6 class="mt-4 mb-2"><?php echo e(__('Total Customers')); ?></h6>
                                            <h3 class="mb-0"><?php echo e($totle_sales); ?> <span class="text-danger text-sm">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-3 col-6">
                                    <div class="card stats-wrapper info-card">
                                        <div class="card-body stats">
                                            ...
                                            <h6 class="mt-4 mb-2"><?php echo e(__('Total Orders')); ?></h6>
                                            <h3 class="mb-0"><?php echo e($totle_order); ?> <span class="text-success text-sm">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-3 col-6">
                                    <div class="card stats-wrapper info-card">
                                        <div class="card-body stats">
                                            ...
                                            <h6 class="mt-4 mb-2"><?php echo e(__('Total Cancel Orders')); ?></h6>
                                            <h3 class="mb-0"><?php echo e($totle_cancel_order); ?> <span class="text-success text-sm">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-3 col-6">
                                    <div class="card stats-wrapper info-card">
                                        <div class="card-body stats">
                                            ...
                                            <h6 class="mt-4 mb-2"><?php echo e(__('Total Refund Orders')); ?></h6>
                                            <h3 class="mb-0"><?php echo e($total_refund_requests); ?> <span
                                ...
                                <div class="col-lg-3 col-6">
                                    <div class="card stats-wrapper info-card">
                                        <div class="card-body stats">
                                            ...
                                            <h6 class="mt-4 mb-2"><?php echo e(__('Total Revenues')); ?></h6>
                                            <h3 class="mb-0"><?php echo e(SetNumberFormat($total_revenues)); ?> <span
                                                    class="text-success text-sm">
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="d-flex align-items-center">
                                                ...
                                                <div class="card-body stats welcome-card">
                                                    <div class="row align-items-center">
                                                        <div class="col-xxl-12">
                                                            ...
                                                            <h4 class="f-w-400">
                                                                <a href="<?php echo e(asset(!empty(Auth::guard('admin')->user()->profile_image) ? get_file(Auth::guard('admin')->user()->profile_image, APP_THEME()) : asset(Storage::url('uploads/profile/avatar.png')))); ?>"
                                                                    target="_blank">
                                                                    <img src="<?php echo e(asset(!empty(Auth::guard('admin')->user()->profile_image) ? get_file(Auth::guard('admin')->user()->profile_image, APP_THEME()) : asset(Storage::url('uploads/profile/avatar.png')))); ?>"
                                                                        alt="user-image" class="wid-35 me-2 img-thumbnail rounded-circle">
                                                                </a>
                                                                <?php echo e(__(Auth::guard('admin')->user()->name)); ?>

                                                            </h4>
                                                            <p><?php echo e(__('Have a nice day! Did you know that you can quickly add your favorite product or category to the theme?')); ?>
                                                            ...
                                                            <div class="dropdown quick-add-btn">
                                                                ...
                                                                <div class="dropdown-menu">
                                                                    ...
                                                                    <a href="#" data-size="lg"
                                                                        data-url="<?php echo e(route('admin.product.create')); ?>"
                                                                        data-ajax-popup="true" data-title="<?php echo e(__('Add Product')); ?>"
                                                                        class="dropdown-item"
                                                                        data-bs-placement="top "><span><?php echo e(__('Add new product')); ?></span></a>

                                                                    <a href="#" data-size="md"
                                                                        data-url="<?php echo e(route('admin.tax.create')); ?>" data-ajax-popup="true"
                                                                        data-title="<?php echo e(__('Create Tax')); ?>" class="dropdown-item"
                                                                        data-bs-placement="top "><span><?php echo e(__('Add new tax')); ?></span></a>

                                                                    <a href="#" data-size="md"
                                                                        data-url="<?php echo e(route('admin.main-category.create')); ?>"
                                                                        data-ajax-popup="true"
                                                                        data-title="<?php echo e(__('Create Main Category')); ?>"
                                                                        class="dropdown-item"
                                                                        data-bs-placement="top"><span><?php echo e(__('Add new main category')); ?></span></a>

                                                                    <a href="#" data-size="md"
                                                                        data-url="<?php echo e(route('admin.coupon.create')); ?>"
                                                                        data-ajax-popup="true" data-title="<?php echo e(__('Create Coupon')); ?>"
                                                                        class="dropdown-item"
                                                                        data-bs-placement="top "><span><?php echo e(__('Add new coupon')); ?></span></a>
                                                                </div>
                                                            </div>
                                                        </div>
                                            ...
                                            <div class="stats-wrapper info-card">
                                                <div class="card-body stats ps-3 pe-3">
                                                    <h6 class=""><?php echo e($store->name); ?></h6>
                                                    <div class="mb-3 qrcode">
                                                        <?php echo QrCode::generate($theme_url); ?>

                                                    </div>
                                                    <div class="d-flex justify-content-between">
                                                        <a href="#!" class="btn btn-light-primary btn-sm w-100 cp_link"
                                                            data-link="<?php echo e($theme_url); ?>" data-bs-toggle="tooltip"
                                                            data-bs-placement="top" title="<?php echo e(__('Click to copy link')); ?>">
                                                            <?php echo e(__('Theme Link')); ?>
                ...
                <div class="col-xxl-7 mb-4">
                    <div class="card min-h-390 overflow-auto card-dash">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            <h5><?php echo e(__('Latest Products')); ?></h5>
                            <a class="btn btn-primary" href="<?php echo e(route('admin.product.index')); ?>"><?php echo e(__('View All')); ?></a>
                        </div>
                        <div class="card-body">
                                    ...
                                    <tbody>
                                        <?php $__currentLoopData = $latests; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $latest): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <a href="<?php echo e(get_file($latest->cover_image_path, APP_THEME())); ?>"
                                                            target="_blank">
                                                            <img src="<?php echo e(get_file($latest->cover_image_path, APP_THEME())); ?>"
                                                                class="wid-25" alt="images">
                                                        </a>
                                                        <div class="ms-3">
                                                            <h6 class="m-0"><?php echo e($latest->name); ?>

                                                            </h6>
                                                        </div>
                                                    </div>
                                                </td>
                                                <?php if($latest->variant_product == 0): ?>
                                                    <td>
                                                        <h6 class="m-0"><?php echo e($latest->product_stock); ?></h6>
                                                    </td>
                                                    <td>
                                                        <h6 class="m-0"><?php echo e($latest->final_price); ?></h6>
                                                    </td>
                                                <?php else: ?>
                                                    <td>
                                                        <h6 class="m-0"><?php echo e(__('In Variant')); ?></h6>
                                                    </td>
                                                    <td>
                                                        <h6 class="m-0"><?php echo e(__('In Variant')); ?></h6>
                                                    </td>
                ...
                <div class="col-xxl-7 mb-4">
                    <div class="card min-h-390 overflow-auto card-dash">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            <h5><?php echo e(__('Customer Vs Guest')); ?></h5>
                            <a class="btn btn-primary" href="<?php echo e(route('admin.reports.index')); ?>"><?php echo e(__('View All')); ?></a>
                        </div>
                        <div class="card-body">
        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <a class="btn btn-primary" href="<?php echo e(route('admin.order.index')); ?>"><?php echo e(__('View All')); ?></a>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table">
                                    ...
                                    <?php $__currentLoopData = $new_orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php if($order->status != 'Cancel Order'): ?>
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <a href="<?php echo e(route('admin.order.view', \Illuminate\Support\Facades\Crypt::encrypt($order->id))); ?>"
...
$btn_class = 'bg-info';
                                                            ...
                                                            class="btn <?php echo e($btn_class); ?>  text-white btn-sm text-sm"
                                                            data-toggle="tooltip" title="<?php echo e(_('Invoice ID')); ?>">
                                                            <span class="btn-inner--icon"></span>
                                                            <span
                                                                class="btn-inner--text">#<?php echo e($order->product_order_id); ?></span>
                                                        </a>
                                                    </div>
                                                </td>
                                                <td>
                                                    <h6 class="m-0">
                                                        <?php echo e(\App\Models\Utility::dateFormat($order->order_date)); ?>
                                                ...
                                                <td>
                                                    <h6 class="m-0">
                                                        ...
                                                        <?php elseif($order->user_id != 0): ?>
                                                            <?php echo e(!empty($order->UserData->name) ? $order->UserData->name : ''); ?>
                                                ...
                                                <td>
                                                    <h6 class="m-0">
                                                        <?php echo e(SetNumberFormat($order->final_price)); ?>
                                                ...
                                                <td class="">
                                                    <h6 class="m-0">
                                                        ...
                                                        <?php elseif($order->payment_type == 'paystack'): ?>
                                                            <?php echo e(__('Paystack')); ?>

                                                        <?php elseif($order->payment_type == 'Mercado'): ?>
                                                            <?php echo e(__('Mercado Pago')); ?>

                                                        <?php elseif($order->payment_type == 'skrill'): ?>
                                                            <?php echo e(__('Skrill')); ?>

                                                        <?php elseif($order->payment_type == 'paymentwall'): ?>
                                                        ...
                                                        <?php elseif($order->payment_type == 'flutterwave'): ?>
                                                            <?php echo e(__('Flutterwave')); ?>

                                                        <?php elseif($order->payment_type == 'mollie'): ?>
                                                            <?php echo e(__('Mollie')); ?>

                                                        <?php elseif($order->payment_type == 'coingate'): ?>
                                                            <?php echo e(__('Coingate')); ?>

                                                        <?php elseif($order->payment_type == 'paytm'): ?>
                                                            <?php echo e(__('Paytm')); ?>

                                                        <?php elseif($order->payment_type == 'POS'): ?>
                                                            <?php echo e(__('POS')); ?>

                                                        <?php elseif($order->payment_type == 'toyyibpay'): ?>
                                                            <?php echo e(__('Toyyibpay')); ?>

                                                        <?php elseif($order->payment_type == 'sspay'): ?>
                                                            <?php echo e(__('Sspay')); ?>

                                                        <?php elseif($order->payment_type == 'Paytabs'): ?>
                                                            <?php echo e(__('Paytabs')); ?>

                                                        <?php elseif($order->payment_type == 'iyzipay'): ?>
                                                            <?php echo e(__('IyziPay')); ?>

                                                        <?php elseif($order->payment_type == 'payfast'): ?>
                                                            <?php echo e(__('PayFast')); ?>

                                                        <?php elseif($order->payment_type == 'benefit'): ?>
                                                            <?php echo e(__('Benefit')); ?>

                                                        <?php elseif($order->payment_type == 'cashfree'): ?>
                                                            <?php echo e(__('Cashfree')); ?>

                                                        <?php elseif($order->payment_type == 'aamarpay'): ?>
                                                            <?php echo e(__('Aamarpay')); ?>

                                                        <?php elseif($order->payment_type == 'telegram'): ?>
                                                            <?php echo e(__('Telegram')); ?>

                                                        <?php elseif($order->payment_type == 'whatsapp'): ?>
                                                            <?php echo e(__('Whatsapp')); ?>

                                                        <?php elseif($order->payment_type == 'paytr'): ?>
                                                            <?php echo e(__('PayTR')); ?>

                                                        <?php elseif($order->payment_type == 'yookassa'): ?>
                                                            <?php echo e(__('Yookassa')); ?>

                                                        <?php elseif($order->payment_type == 'Xendit'): ?>
                                                ...
                                                <td class="">
                                                    <?php if($order->delivered_status == 0): ?>
                                                        <button type="button"
                                                            class="badge-same btn btn-sm btn-info btn-icon rounded-pill">

                                                            <span class="btn-inner--text"> <?php echo e(__('Pending')); ?> :
                                                                <?php echo e(\App\Models\Utility::dateFormat($order->order_date)); ?>

                                                            </span>
                                                        </button>
                                                    <?php elseif($order->delivered_status == 1): ?>
                                                        <button type="button"
                                                            class="badge-same btn btn-sm btn-success btn-icon rounded-pill">

                                                            <span class="btn-inner--text"> <?php echo e(__('Delivered')); ?> :
                                                                <?php echo e(\App\Models\Utility::dateFormat($order->delivery_date)); ?>

                                                            </span>
                                                        </button>
                                                    <?php elseif($order->delivered_status == 2): ?>
                                                        <button type="button"
                                                            class="badge-same btn btn-sm btn-danger btn-icon rounded-pill">

                                                            <span class="btn-inner--text"> <?php echo e(__('Cancel')); ?> :
                                                                <?php echo e(\App\Models\Utility::dateFormat($order->cancel_date)); ?>

                                                            </span>
                                                        </button>
                                                    <?php elseif($order->delivered_status == 3): ?>
                                                        <button type="button"
                                                            class="badge-same btn btn-sm btn-danger btn-icon rounded-pill">

                                                            <span class="btn-inner--text"> <?php echo e(__('Return')); ?> :
                                                                <?php echo e(\App\Models\Utility::dateFormat($order->return_date)); ?>

                                                            </span>
                                                        </button>
                                                    <?php elseif($order->delivered_status == 4): ?>
                                                        <button type="button"
                                                            class="badge-same btn btn-sm btn-warning btn-icon rounded-pill">

                                                            <span class="btn-inner--text"> <?php echo e(__('Confirmed')); ?> :
                                                                <?php echo e(\App\Models\Utility::dateFormat($order->confirmed_date)); ?>

                                                            </span>
                                                        </button>
                                                    <?php elseif($order->delivered_status == 5): ?>
                                                        <button type="button"
                                                            class="badge-same btn btn-sm btn-secondary btn-icon rounded-pill">

                                                            <span class="btn-inner--text"> <?php echo e(__('Picked Up')); ?> :
                                                                <?php echo e(\App\Models\Utility::dateFormat($order->picked_date)); ?>

                                                            </span>
                                                        </button>
                                                    <?php elseif($order->delivered_status == 6): ?>
                                                        <button type="button"
                                                            class="badge-same btn btn-sm btn-dark btn-icon rounded-pill">

                                                            <span class="btn-inner--text"> <?php echo e(__('Shipped')); ?> :
                                                                <?php echo e(\App\Models\Utility::dateFormat($order->shipped_date)); ?>
        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h5><?php echo e(__('Top Selleing Products')); ?></h5>
                    <a class="btn btn-primary" href="<?php echo e(route('admin.product.index')); ?>"><?php echo e(__('View All')); ?></a>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table">
                            <thead>
                                <tr>
                                    ...
                                    <th><?php echo e(__('Cover Image')); ?></th>
                                    <th><?php echo e(__('Varint')); ?></th>
                                    <th><?php echo e(__('Review')); ?></th>
                                    <th><?php echo e(__('Price')); ?></th>
                                    <th><?php echo e(__('Stock Status')); ?></th>
                                    <th><?php echo e(__('Stock Quntity')); ?></th>
                                </tr>
                            </thead>
                            <tbody>
                                <?php $__currentLoopData = $topSellingProducts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td> <?php echo e(!empty($product->ProductData()) ? $product->ProductData()->name : ''); ?>

                                        </td>
                                        <td> <img src="<?php echo e(get_file($product->cover_image_path, APP_THEME())); ?>"
                                                alt="" width="100" class="cover_img<?php echo e($product->id); ?>">
                                        </td>
                                        <td> <?php echo e($product->variant_product == 1 ? 'has variant' : 'no variant'); ?> </td>
                                        <td> <i class="ti ti-star text-warning "></i><?php echo e($product->average_rating); ?> </td>
                                        <?php if($product->variant_product == 0): ?>
                                            <td> <?php echo e(SetNumberFormat($product->price)); ?> </td>
                                        <?php else: ?>
                                            <td><?php echo e(__('In Variant')); ?></td>
                                        <?php endif; ?>
                                        <td>
                                            <?php if($product->variant_product == 1): ?>
                                                <span
                                                    class="badge rounded p-2 f-w-600  bg-light-warning"><?php echo e(__('In Variant')); ?></span>
                                            <?php else: ?>
                                                <?php if($product->track_stock == 0): ?>
                                                    ...
                                                    <?php elseif($product->stock_status == 'on_backorder'): ?>
                                                        <span class="badge rounded p-2 f-w-600  bg-light-warning">
                                                            <?php echo e(__('On Backorder')); ?></span>
                                                    <?php else: ?>
                                                        <span class="badge rounded p-2 f-w-600  bg-light-primary">
                                                            <?php echo e(__('In stock')); ?></span>
                                                    <?php endif; ?>
                                                <?php else: ?>
                                                    <?php if($product->product_stock <= $out_of_stock_threshold): ?>
                                                        <span class="badge rounded p-2 f-w-600  bg-light-danger">
                                                            <?php echo e(__('Out of stock')); ?></span>
                                                    <?php else: ?>
                                                        <span class="badge rounded p-2 f-w-600  bg-light-primary">
...
<?php $__env->startPush('custom-script'); ?>
    ...
    <script>
        ...
        (function() {
            var options = {
                ...
                series: [{
                    name: 'New Customer',
                    data: <?php echo json_encode($chartData['registerTotal']); ?>

                }, {
                    name: 'New Guest',
                    data: <?php echo json_encode($chartData['newguestTotal']); ?>
    ...
    <script>
        ...
        $(document).ready(function() {
            var customURL = <?php echo json_encode($theme_url); ?>;
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\01026\OneDrive\Desktop\Abd_elrahman\anaonline\AnaLive\resources\views/dashboard.blade.php ENDPATH**/ ?>