    ...
    cc.run({
        ...
        onAccept: function(cookie) {
            if (!getCookie('ecom_cookie_status')) {
                ...
                $.ajax({
                    url: '<?php echo e(route('admin.cookie-consent')); ?>',
                    datType: 'json',
                    data: {
                        cookie: cookie,
                    },
...
<?php /**PATH C:\Users\01026\OneDrive\Desktop\Abd_elrahman\anaonline\AnaLive\resources\views/layouts/cookie_consent.blade.php ENDPATH**/ ?>